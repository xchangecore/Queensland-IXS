...
public class InterestGroupInfoUtil {
    ...
    private static final Pattern interestGroupIDPattern = Pattern.compile(interestGroupIDOpenTag
            + "(.+?)" + interestGroupIDCloseTag, Pattern.DOTALL | Pattern.MULTILINE);
    private static final Pattern interestGroupTypePattern = Pattern.compile(
            interestGroupTypeOpenTag + "(.+?)" + interestGroupTypeCloseTag, Pattern.DOTALL
                    | Pattern.MULTILINE);
    private static final Pattern namePattern = Pattern.compile(
            nameOpenTag + "(.+?)" + nameCloseTag, Pattern.DOTALL | Pattern.MULTILINE);
    private static final Pattern descriptionPattern = Pattern.compile(descriptionOpenTag + "(.+?)"
            + descriptionCloseTag, Pattern.DOTALL | Pattern.MULTILINE);
    private static final Pattern owningCorePattern = Pattern.compile(owningCoreOpenTag + "(.+?)"
            + owningCoreCloseTag, Pattern.DOTALL | Pattern.MULTILINE);
    private static final Pattern detailedInfoPattern = Pattern.compile(detailedInfoOpenTag
            + "(.+?)" + detailedInfoCloseTag, Pattern.DOTALL | Pattern.MULTILINE);
    ...
    public static final String toInterestDetailedInfoString(String interestGroupInfoStr) {
        ...
        try {
            ...
            if (m.find()) {
                ...
                log
                        .error("InterestGroupInfoUtil:toInterestGroup: Can't find interestGroupID  in the received info string");
            }

        } catch (Throwable e) {
            log.error("Failure occurs while parsing InterestGroupInfo: str[" + interestGroupInfoStr
                    + "]");
            e.printStackTrace();
        }
        return detailedInfo;
    ...
    public static final InterestGroupInfo toInterestGroupInfo(String interestGroupInfoStr) {
        ...
        try {
            ...
            if (m.find()) {
                ...
                log
                        .error("InterestGroupInfoUtil:toInterestGroupInfo: Can't find interestGroupID  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .error("InterestGroupInfoUtil:toInterestGroupInfo: Can't find interestGroupType  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .warn("InterestGroupInfoUtil:toInterestGroupInfo: Can't find interestGroup name  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .warn("InterestGroupInfoUtil:toInterestGroupInfo: Can't find interestGroup description  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .error("InterestGroupInfoUtil:toInterestGroupInfo: Can't find interestGroup's owning core  in the received info string");
            }
        } catch (Throwable e) {
            log.error("Failure occurs while parsing InterestGroupInfo: str[" + interestGroupInfoStr
                    + "]");
    ...
    public static final InterestGroup toInterestGroup(String interestGroupInfoStr) {
        ...
        try {
            ...
            if (m.find()) {
                ...
                log
                        .error("InterestGroupInfoUtil:toInterestGroup: Can't find interestGroupType  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .warn("InterestGroupInfoUtil:toInterestGroup: Can't find interestGroup name  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .warn("InterestGroupInfoUtil:toInterestGroup: Can't find interestGroup description  in the received info string");
            }
            ...
            if (m.find()) {
                ...
                log
                        .error("InterestGroupInfoUtil:toInterestGroup: Can't find interestGroup's owning core  in the received info string");
            }
    ...
    public static final String toXMLString(InterestGroupInfo interestGroupInfo, String detailedlInfo) {
        ...
        sb.append(interestGroupIDOpenTag + StringEscapeUtils.escapeXml(interestGroupInfo.getInterestGroupID())
                + interestGroupIDCloseTag);
        sb.append(interestGroupTypeOpenTag + StringEscapeUtils.escapeXml(interestGroupInfo.getInterestGroupType())
                + interestGroupTypeCloseTag);
        sb.append(nameOpenTag + StringEscapeUtils.escapeXml(interestGroupInfo.getName())
        		+ nameCloseTag);
        sb.append(descriptionOpenTag + StringEscapeUtils.escapeXml(interestGroupInfo.getDescription())
        		+ descriptionCloseTag);
        sb.append(owningCoreOpenTag + StringEscapeUtils.escapeXml(interestGroupInfo.getOwningCore())
        		+ owningCoreCloseTag);
    ...
    public static final String toXMLString(InterestGroup interestGroup, String detailedInfo) {
        StringBuffer sb = new StringBuffer();
        sb.append(interestGroupIDOpenTag + StringEscapeUtils.escapeXml(interestGroup.getInterestGroupID())
                + interestGroupIDCloseTag);
        sb.append(interestGroupTypeOpenTag + StringEscapeUtils.escapeXml(interestGroup.getInterestGroupType())
                + interestGroupTypeCloseTag);
