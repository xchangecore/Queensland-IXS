...
public class ProductSubscriptionByTypeHibernateDAO extends
		GenericHibernateDAO<ProductSubscriptionByType, Integer> implements
	...
	@Override
	public List<ProductSubscriptionByType> findByInterestGroupIdAndProductType(
			String interestGroupID, String productType) {
	...
	@Override
	public List<ProductSubscriptionByType> findBySubscriberName(
	...
	@Override
	public List<ProductSubscriptionByType> findBySubscriptionId(
