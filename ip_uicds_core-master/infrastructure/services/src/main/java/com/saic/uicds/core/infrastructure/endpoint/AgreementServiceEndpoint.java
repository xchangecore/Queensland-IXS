...
public class AgreementServiceEndpoint
    ...
    public UpdateAgreementResponseDocument updateAgreement(UpdateAgreementRequestDocument requestDoc) {
        ...
        log.debug("updateAgreement: id=" + requestDoc.getUpdateAgreementRequest().getAgreement());

        AgreementType agreement = agreementService.updateAgreement(
            requestDoc.getUpdateAgreementRequest().getAgreement().getPrincipals().getRemoteCore().getStringValue(),
            requestDoc.getUpdateAgreementRequest().getAgreement());
    ...
    public RescindAgreementResponseDocument rescindAgreement(
        RescindAgreementRequestDocument requestDoc) {

        log.debug("rescindAgreement: id=" + requestDoc.getRescindAgreementRequest().getCoreID());

        String coreID = agreementService.rescindAgreement(requestDoc.getRescindAgreementRequest().getCoreID());

        RescindAgreementResponseDocument response = RescindAgreementResponseDocument.Factory.newInstance();
        response.addNewRescindAgreementResponse().setCoreID(coreID);

        // return agreementService.rescindAgreement(coreID);
    ...
    public GetAgreementResponseDocument getAgreement(GetAgreementRequestDocument requestDoc)
        ...
        log.debug("getAgreement: id=" + requestDoc.getGetAgreementRequest().getCoreID());

        AgreementType agreement = agreementService.getAgreement(requestDoc.getGetAgreementRequest().getCoreID());
        if (agreement != null) {
            ...
            throw new SOAPException("Agreement: " + requestDoc.getGetAgreementRequest().getCoreID()
                + " not existed");
        }
    }
    ...
    public GetAgreementListResponseDocument getAgreementList(
        GetAgreementListRequestDocument requestDoc) {
