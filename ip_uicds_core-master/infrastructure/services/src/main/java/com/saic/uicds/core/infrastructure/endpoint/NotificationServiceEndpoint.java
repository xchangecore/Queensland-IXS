 ...
 * @see com.saic.uicds.core.infrastructure.endpoint.ResourceProfileServiceEndpoint
 * @see com.saic.uicds.core.infrastructure.endpoint.ResourceInstanceServiceEndpoint
 * @idd
 */
@Endpoint
public class NotificationServiceEndpoint
    ...
    public GetCurrentMessageResponseDocument GetCurrentMessage(
        GetCurrentMessageRequestDocument request) {

        if (log.isDebugEnabled()) {
            log.debug("GetCurrentMessage: " + request);
        }
        ...
        XmlObject[] to = request.getGetCurrentMessageRequest().selectChildren(
        ...
        if (to.length > 0) {
            ...
            NotificationMessageHolderType notificationMessage = notificationService.getCurrentMessage(new QName(
                topicName));
    ...
    public GetMessagesResponseDocument GetMessages(GetMessagesRequestDocument request) {
        ...
        if (to.length > 0) {
            ...
            NotificationMessageHolderType[] notificationMessageArray = notificationService.getMessages(
                entityID, 1);
    ...
    public GetMatchingMessagesResponseDocument getMatchingMessages(
        GetMatchingMessagesRequestDocument request) throws DatatypeConfigurationException {
