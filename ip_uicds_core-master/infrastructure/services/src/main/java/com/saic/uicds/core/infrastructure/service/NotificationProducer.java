...
public interface NotificationProducer {
    ...
    public static final QName FIXED_SET_QNAME = new QName(WSN_NAMESPACE, "FixedTopicSet",
            WST_PREFIX);
    public static final QName TOPIC_DIALECT_QNAME = new QName(WSN_NAMESPACE,
            "TopicExpressionDialect", WSN_PREFIX);
    public static final QName TOPIC_EXPRESSION_QNAME = new QName(WSN_NAMESPACE, "TopicExpression",
            WSN_PREFIX);
     ...
     * 
     * @param who The EPR to send the notifications TO
     * @param what filter to set criteria for publication, like topic names,message patterns
     * @ssdd
     */
    public void subscribe(EndpointReferenceType who, FilterType what) 
    	throws InvalidProductTypeException, NullSubscriberException,
    	EmptySubscriberNameException, InvalidProductIDException;
     ...
     * @ssdd
     */
    public NotificationMessageHolderType getCurrentMessage(QName tp);// throws
}