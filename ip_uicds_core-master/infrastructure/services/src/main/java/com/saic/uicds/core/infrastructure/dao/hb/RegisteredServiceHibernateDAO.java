...
public class RegisteredServiceHibernateDAO extends
		GenericHibernateDAO<RegisteredService, Integer> implements
		RegisteredServiceDAO {
	...
	public Set<RegisteredService> findByServiceType(
			RegisteredService.SERVICE_TYPE serviceType) {
	...
	public Set<RegisteredService> findByServiceTypeAndCoreName(
		...
		List<RegisteredService> registeredUICDSServiceList = findByCriteria(
	...
	public Set<RegisteredService> findByUrnAndCoreName(String urn,
			String coreName) {
	...
	public Set<RegisteredService> findByServiceNameAndCoreName(
			String serviceName, String coreName) {
