...
public class AtomModule extends com.usersmarts.pub.atom.xml.AtomModule{
    ...
    static class ServiceParser extends StaxParser {
    ...
    static class WorkspaceParser extends StaxParser {
    ...
    static class CollectionParser extends StaxParser {
    ...
    static class CategoriesParser extends StaxParser {
    ...
    static class ServiceFormatter extends StaxFormatter {
        @Override
            ...
            for (Workspace workspace : service.getWorkspaces()) {
                ...
                for(Object l : workspace.getList(ATOM.LINK)) {
                    if(l instanceof Link && StringUtils.isNotEmpty(((Link)l).getHref())) {
                        ...
                        writer.attribute("type", Coerce.toString(link.getType(), "application/atom+xml"));
