...
public interface IAPService {
     ...
     * @ssdd
     */
    public ProductPublicationStatus setApprovedIAP(IdentificationType workProductID, String incidentID);
     ...
     * @ssdd
     */
    public ProductPublicationStatus attachWorkProductToIAP(
        IdentificationType[] workProductIdentificationArray, String iapWpId);
