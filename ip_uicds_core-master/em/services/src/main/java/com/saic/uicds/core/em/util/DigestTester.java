...
public class DigestTester
    ...
    public static EventType getEventElementFromDigest(DigestType digest, Map<String, String> codes) {
        ...
        for (XmlObject obj : events) {
            ...
            for (String codespace : codes.keySet()) {
                if (EMDigestHelper.objectHasWhatType(codespace, codes.get(codespace), null, null,
                    obj)) {
                    object = obj;
                    found = true;
                    break;
    ...
    public static boolean checkLocationGMLPolygon(DigestType digest, List<String> points) {
        ...
        for (LocationType location : locationElements) {
            ...
            if (geoLocations != null && geoLocations.length > 0) {
                for (XmlObject object : geoLocations) {
                    GeoLocationType geo = (GeoLocationType) object;
                    XmlObject[] ucorePolygons = geo.selectChildren(
            ...
            if (geoLocations != null && geoLocations.length > 0) {
                for (XmlObject object : geoLocations) {
                    ...
                    XmlObject[] ucoreCircles = geo.selectChildren(
                        CircleByCenterPointType.type.getName().getNamespaceURI(),
                        "CircleByCenterPoint");
                    if (ucoreCircles.length > 0) {
                        ...
                        if (circle.getCircleByCenterPoint().getRadius().getStringValue().equals(
                            radius)
    ...
    public static boolean hasAOccursAtElement(DigestType digest, String eventID, String reqLocID) {
        ...
        boolean found = false;
        XmlObject[] occursAts = digest.selectChildren(
    ...
    public static boolean checkLocationAddresses(DigestType digest) {
        ...
        List<LocationType> locationElements = EMDigestHelper.getLocationElements(digest);
        for (LocationType location : locationElements) {
            XmlObject[] addresses = location.selectChildren(
    ...
    public static OrganizationType getOrganizationElementFromDigest(DigestType digest,
        ...
        XmlObject[] organizations = digest.selectChildren(
    ...
    public static boolean hasLocatedAtElement(DigestType digest, String id, String locationID) {
        ...
        boolean found = false;
        XmlObject[] locatedAts = digest.selectChildren(
            EntityLocationExtendedRelationshipType.type.getName().getNamespaceURI(),
            LOCATED_AT_TYPE);
    ...
    public static boolean hasAHasDestinationOfElement(DigestType digest, String entityID) {
        ...
        boolean found = false;
        XmlObject[] hasDestinationOfs = digest.selectChildren(
    ...
    public static boolean hasACauseOfElement(DigestType digest, String causeID, String effectID) {
        ...
        boolean found = false;
        XmlObject[] causeOfs = digest.selectChildren(
            CauseOfRelationshipType.type.getName().getNamespaceURI(), CAUSE_OF_TYPE);
    ...
    public static boolean hasInvolvedInElement(DigestType digest, String agentID, String eventID) {
        ...
        boolean found = false;
        XmlObject[] involvedIns = digest.selectChildren(
            AgentEventRelationshipType.type.getName().getNamespaceURI(), INVOLVED_IN_TYPE);
    ...
    public static boolean checkSimpleProperty(DigestType digest, String thingType, String eventID,
        ...
        if (things.length > 0) {
            ...
            if (thing != null) {
                XmlObject[] props = thing.selectChildren(
                ...
                for (XmlObject prop : props) {
                    ...
                    // one)
                    XmlObject codespaceAttr = prop.selectAttribute(
                    ...
                    if (codespaceAttr != null) {
                        ...
                        if (XmlUtil.getTextFromAny(codespaceAttr).equals(codespace)) {
                            ...
                            if (code != null) {
                                XmlObject codeAttr = prop.selectAttribute(
    ...
    public static boolean checkEventWhatElement(DigestType digest, String eventID,
        String codespace, String code, String label, String value) {
    ...
    public static boolean checkEntityWhatElement(DigestType digest, String entityID,
        String codespace, String code, String label, String value) {
    ...
    public static boolean checkOrganizationWhatElement(DigestType digest, String entityID,
        String codespace, String code, String label, String value) {

        boolean ok = false;
        XmlObject[] entities = digest.selectChildren(
            OrganizationType.type.getName().getNamespaceURI(), ORGANIZATION_THING_TYPE);
        if (entities.length > 0) {
            EntityType entity = null;
            for (XmlObject obj : entities) {
