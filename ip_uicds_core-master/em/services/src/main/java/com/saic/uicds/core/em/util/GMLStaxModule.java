...
public class GMLStaxModule extends com.usersmarts.geo.gml.GMLStaxModule{

    @Override
    public void configure(Configuration cfg) {
        XmlParserFinder spf = new StaxParserFinder(new GMLStaxParser()).localPart(
                GMLStaxParser.getSupportedLocalParts()).namespace(GML3.NAMESPACE);
        cfg.registerFinder(spf);
        StaxFormatterFinder sff = new StaxFormatterFinder(new GMLStaxFormatter(), Geometry.class,
                Envelope.class);
