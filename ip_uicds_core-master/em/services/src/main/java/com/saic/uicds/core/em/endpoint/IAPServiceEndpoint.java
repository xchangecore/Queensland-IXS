...
public class IAPServiceEndpoint
    ...
    public CreateIAPResponseDocument createIAP(CreateIAPRequestDocument requestDoc) {
        ...
        response.addNewCreateIAPResponse().addNewWorkProductPublicationResponse().set(
    ...
    public CreateICSFormResponseDocument createICSForm(CreateICSFormRequestDocument requestDoc) {
        ...
        response.addNewCreateICSFormResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(status));
        return response;
    ...
    public GetIAPResponseDocument getIAP(GetIAPRequestDocument requestDoc) {
        ...
        response.addNewGetIAPResponse().setWorkProduct(
            WorkProductHelper.toWorkProduct(productService.getProduct(requestDoc.getGetIAPRequest().getWorkProductIdentification())));
    ...
    public GetICSFormResponseDocument getICSForm(GetICSFormRequestDocument requestDoc) {
        ...
        response.addNewGetICSFormResponse().setWorkProduct(
            WorkProductHelper.toWorkProduct(productService.getProduct(requestDoc.getGetICSFormRequest().getWorkProductIdentification())));
    ...
    public UpdateIAPResponseDocument updateIAP(UpdateIAPRequestDocument requestDoc) {
        ...
        ProductPublicationStatus status = iapService.updateIAP(iap, workProductIdentification,
            false);

        responseDoc.addNewUpdateIAPResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(status));
    ...
    public UpdateICSFormResponseDocument updateICSForm(UpdateICSFormRequestDocument requestDoc) {
        ...
        responseDoc.addNewUpdateICSFormResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(status));
    ...
    public SetApprovedIAPResponseDocument setApprovedIAP(SetApprovedIAPRequestDocument requestDoc) {
        ...
        // call service method
        ProductPublicationStatus status = iapService.setApprovedIAP(
            requestDoc.getSetApprovedIAPRequest().getWorkProductIdentification(),
        ...
        response.addNewSetApprovedIAPResponse().addNewWorkProductPublicationResponse().set(
            statusXML);
    ...
    public GetApprovedIAPResponseDocument getApprovedIAP(GetApprovedIAPRequestDocument requestDoc)
        ...
        if (workProduct != null) {
            ...
            response.getGetApprovedIAPResponse().addNewWorkProduct().set(
    ...
    public AttachWorkProductToIAPResponseDocument attachWorkProductToIAP(
        AttachWorkProductToIAPRequestDocument requestDoc) {
        ...
        ProductPublicationStatus status = iapService.attachWorkProductToIAP(
            requestDoc.getAttachWorkProductToIAPRequest().getWorkProductList().getWorkProductIdentificationArray(),
            iapWpId);
        response.getAttachWorkProductToIAPResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(status));
    ...
    public GetICSFormListResponseDocument getICSFormList(GetICSFormListRequestDocument requestDoc) {
        ...
        for (WorkProduct wp : wps) {
            response.getGetICSFormListResponse().addNewWorkProduct().set(
                WorkProductHelper.toWorkProductDocument(wp));
        }
        return response;
    }
