...
import com.saic.uicds.core.infrastructure.util.GeoUtil;
...
public class EMGeoUtil
    ...
    public static CircularRegionType getCircle(String circleString) {
        ...
        if (loc != null) {
            ...
            circular.addNewCircularRegionCenterCoordinate().set(
        ...
        if (circle.sizeOfCircularRegionCenterCoordinateArray() > 0
            ...
            if (lat != null && lat.sizeOfLatitudeDegreeValueArray() > 0 && lon != null
                ...
                if (circle.getCircularRegionRadiusLengthMeasureArray(0).sizeOfMeasureValueArray() > 0) {
                    ...
                    XmlObject[] objects = circle.getCircularRegionRadiusLengthMeasureArray(0).selectChildren(
                        new QName(MeasurePointValueType.type.getName().getNamespaceURI(),
                            "MeasurePointValue"));
                    if (objects.length > 0) {
                        ...
                        if (circle.getCircularRegionRadiusLengthMeasureArray(0).getLengthUnitCode() != null) {
                            gCircle.getRadius().setUom(
                                circle.getCircularRegionRadiusLengthMeasureArray(0).getLengthUnitCode().getStringValue());
                        } else {
                            // Default to miles
    ...
    public static PolygonType getPolygon(TwoDimensionalGeographicCoordinateType[] coords) {
        ...
        XmlUtil.substitute(gPolygon.addNewExterior().addNewAbstractRing(),
            InfrastructureNamespaces.NS_GML, DigestConstant.S_LinearRing, LinearRingType.type,
            linearRing);
    ...
    protected static Coordinate parseCoordinateUsingTwoDimensionalGeographicCoordinateType(
        TwoDimensionalGeographicCoordinateType coord) {
        ...
        if (area.sizeOfAreaPolygonGeographicCoordinateArray() > 0) {
            ...
            if (circle != null) {
                ...
                if (circle.sizeOfCircularRegionCenterCoordinateArray() > 0
                    ...
                    radius = Coerce.toDouble(
                        circle.getCircularRegionRadiusLengthMeasureArray(0).getMeasureValueArray(0),
                        1.0);
                }
                if (coord != null) {
    ...
    private static String toCoordinateString(TwoDimensionalGeographicCoordinateType coord) {
        ...
        coordBuffer.append(fromDegMinSec(
            coord.getGeographicCoordinateLatitude().getLatitudeDegreeValueArray(0).getStringValue(),
        ...
        coordBuffer.append(fromDegMinSec(
            coord.getGeographicCoordinateLongitude().getLongitudeDegreeValueArray(0).getStringValue(),
