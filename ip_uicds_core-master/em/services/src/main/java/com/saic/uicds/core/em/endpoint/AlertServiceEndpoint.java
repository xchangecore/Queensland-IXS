...
public class AlertServiceEndpoint
    ...
    public CreateAlertResponseDocument createAlert(CreateAlertRequestDocument request)
        ...
        ProductPublicationStatus status = alertService.createAlert(
            request.getCreateAlertRequest().getIncidentId(),
            request.getCreateAlertRequest().getAlert());
        response.addNewCreateAlertResponse().addNewWorkProductPublicationResponse().set(
    ...
    public GetAlertByAlertIdResponseDocument getAlertByAlertId(
        GetAlertByAlertIdRequestDocument requestDoc) throws DatatypeConfigurationException {
...
//        request.addNewGetListOfAlertsRequest().addNewNamespaceMap().addNewItem().set(namespace);
    ...
    public CancelAlertResponseDocument cancelAlert(CancelAlertRequestDocument requestDoc)
        ...
        responseDoc.addNewCancelAlertResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(status));
        return responseDoc;
    }
}
