...
public class DetailedCFSMessageUtil {
    ...
    public static UICDSIncidentType populateIncident(UICDSIncidentType uicdsIncident,
        DetailedCFSMessageReader reader) throws DetailedCFSMessageXMLException,
        ...
        if (uicdsIncident != null) {
            ...
            if ((uicdsIncident.getActivityDescriptionTextArray() != null)
                ...
                uicdsIncident.getActivityDescriptionTextArray(0).setStringValue(
                    reader.read(DetailedCFSMessageReader.ACTIVITY_DESC_TEXT));
            }
            ...
            if ((uicdsIncident.getActivityCategoryTextArray() != null)
                ...
                uicdsIncident.getActivityCategoryTextArray(0).setStringValue(
                    reader.read(DetailedCFSMessageReader.CALL_TYPE_TEXT));
            }
            ...
            if (uicdsIncident.getIncidentLocationArray() != null
                ...
                addressDoc.addNewAddressFullText().setStringValue(
                    reader.read(DetailedCFSMessageReader.ADDRESS_FULLTEXT));
                if (uicdsIncident.getIncidentLocationArray(0).getLocationAddressArray() != null
                    ...
                    uicdsIncident.getIncidentLocationArray(0).getLocationAddressArray(0).set(
                        addressDoc.getAddressFullText());
                }
                ...
                if (uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray() != null
                    ...
                    && uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                        0).getCircularRegionCenterCoordinateArray() != null
                    && uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                        0).getCircularRegionCenterCoordinateArray().length > 0) {

                    if (uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                        0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLatitude() != null) {
                        ...
                        if (!latStr.isEmpty()) {
                            ...
                            uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                                0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLatitude().addNewLatitudeDegreeValue().setStringValue(
                                latVals[0]);
                            uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                                0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLatitude().addNewLatitudeMinuteValue().setStringValue(
                                latVals[1]);
                            uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                                0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLatitude().addNewLatitudeSecondValue().setStringValue(
                                latVals[2]);
                        }
                    }
                    // Longitude (LEITSC:
                    ...
                    if (uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                        0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLongitude() != null) {
                        if (!longStr.isEmpty()) {
                            String longVals[] = EMGeoUtil.toDegMinSec(Double.parseDouble(longStr));
                            uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                                0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLongitude().addNewLongitudeDegreeValue().setStringValue(
                                longVals[0]);
                            uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                                0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLongitude().addNewLongitudeMinuteValue().setStringValue(
                                longVals[1]);
                            uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                                0).getCircularRegionCenterCoordinateArray(0).getGeographicCoordinateLongitude().addNewLongitudeSecondValue().setStringValue(
                                longVals[2]);
                        }
                    }
                    // RaduisLength
                    if (uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                        0).getCircularRegionRadiusLengthMeasureArray() != null
                        && uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                            0).getCircularRegionRadiusLengthMeasureArray().length > 0) {
                        MeasurePointValueType measurePoint = MeasurePointValueType.Factory.newInstance();
                        measurePoint.setStringValue("0.0");
                        uicdsIncident.getIncidentLocationArray(0).getLocationAreaArray(0).getAreaCircularRegionArray(
                            0).getCircularRegionRadiusLengthMeasureArray(0).addNewMeasureValue().set(
                            measurePoint);
                    }
                }
            }
            ...
            jurisdictionIdentification.addNewIdentifier().setStringValue(
                reader.read(DetailedCFSMessageReader.ORG_IDENTIFICATION_ID));
            if (uicdsIncident.getIncidentJurisdictionalOrganizationArray() != null
                ...
                uicdsIncident.getIncidentJurisdictionalOrganizationArray(0).getOrganizationIdentificationArray(
                    0).set(jurisdictionIdentification);
            }
            // Set Incident Event
            if (uicdsIncident.getIncidentEventArray() != null
                ...
                if (incidentEvent.getActivityIdentificationArray() != null
                    ...
                    incidentEvent.getActivityIdentificationArray(0).addNewIdentificationID().setStringValue(
                        reader.read(DetailedCFSMessageReader.ACTIVITY_IDENTIFICATION));
                }
                if (incidentEvent.getActivityStatusArray() != null
                    & incidentEvent.getActivityStatusArray().length > 0) {
                    incidentEvent.getActivityStatusArray(0).addNewStatusDescriptionText().setStringValue(
                        reader.read(DetailedCFSMessageReader.ACTIVITY_STATUS_TEXT));
                }
                ...
                if (incidentEvent.getActivityDescriptionTextArray() != null
                    ...
                    incidentEvent.getActivityDescriptionTextArray(0).setStringValue(
                        jurisdictionIdentification.getIdentifier().getStringValue());
                }
            }
    ...
    public static UICDSIncidentType createUICDSIncident() {
        ...
        circularRegion.addNewCircularRegionRadiusLengthMeasure().addNewLengthUnitCode().setStringValue(
            "SMI");
