...
@Endpoint
public class LEITSCServiceEndpoint implements ServiceNamespaces {
    ...
    public PostDetailedCFSMessageResponseDocument postDetailedCFSMessage(
        PostDetailedCFSMessageRequestDocument requestDoc) throws XmlException,
        DetailedCFSMessageException, DetailedCFSMessageXMLException,
    ...
    public GetLEITSCIncidentResponseDocument getLEITSCIncident(
        GetLEITSCIncidentRequestDocument requestDoc) {
