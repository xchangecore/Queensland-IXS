...
public class TaskingServiceEndpoint
    ...
    public CreateTaskListResponseDocument createTaskList(CreateTaskListRequestDocument requestDoc) {
        ...
        ProductPublicationStatus status = taskingService.createTaskList(entityId, incidentId,
            taskList);
        CreateTaskListResponseDocument responseDoc = CreateTaskListResponseDocument.Factory.newInstance();
        responseDoc.addNewCreateTaskListResponse().addNewWorkProductPublicationResponse().set(
    ...
    public UpdateTaskListResponseDocument updateTaskList(UpdateTaskListRequestDocument requestDoc) {
        ...
        responseDoc.addNewUpdateTaskListResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(status));
        return responseDoc;
    }
    ...
    public GetTaskListResponseDocument getTaskList(GetTaskListRequestDocument requestDoc) {
        ...
        responseDoc.addNewGetTaskListResponse().setWorkProduct(
            WorkProductHelper.toWorkProduct(workProductService.getProduct(requestDoc.getGetTaskListRequest().getWorkProductIdentification())));
    ...
    public GetTaskListByIdResponseDocument getTaskListByEntityIdAndIncidentId(
        GetTaskListByIdRequestDocument requestDoc) {
        ...
        response.setWorkProduct(WorkProductHelper.toWorkProduct(taskingService.getTaskListByEntityIdAndIncidentId(
            entityId, incidentId)));
