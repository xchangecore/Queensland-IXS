...
public class IncidentCommandServiceEndpoint
    ...
    public GetCommandStructureByIncidentResponseDocument getCommandStructureByIncident(
        ...
        response.addNewGetCommandStructureByIncidentResponse().setWorkProduct(
            WorkProductHelper.toWorkProduct(icService.getCommandStructureByIncident(request.getGetCommandStructureByIncidentRequest())));
    ...
    public GetCommandStructureResponseDocument getCommandStructure(
        GetCommandStructureRequestDocument request) {

        GetCommandStructureResponseDocument response = GetCommandStructureResponseDocument.Factory.newInstance();
        response.addNewGetCommandStructureResponse().setWorkProduct(
            WorkProductHelper.toWorkProduct(productService.getProduct(request.getGetCommandStructureRequest().getWorkProductIdentification())));
    ...
    public CreateCommandStructureResponseDocument createCommandStructure(
        ...
        updateRequest.addNewUpdateCommandStructureRequest().addNewOrganizationElement().set(
            request.getCreateCommandStructureRequest().getOrganizationElement());
        ...
        response.addNewCreateCommandStructureResponse().addNewWorkProductPublicationResponse().set(
    ...
    public UpdateCommandStructureResponseDocument updateCommandStructure(
        ...
        orgDoc.addNewOrganizationElement().set(
            request.getUpdateCommandStructureRequest().getOrganizationElement());

        UpdateCommandStructureResponseDocument response = UpdateCommandStructureResponseDocument.Factory.newInstance();
        response.addNewUpdateCommandStructureResponse().addNewWorkProductPublicationResponse().set(
            WorkProductHelper.toWorkProductPublicationResponse(icService.updateCommandStructure(
                request.getUpdateCommandStructureRequest().getWorkProductIdentification(), orgDoc,
